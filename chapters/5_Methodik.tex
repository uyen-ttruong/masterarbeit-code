...
\begin{equation}
\Delta P = -\Delta EC_{rel} \cdot \frac{1 - (1 + r)^{-T}}{r} \cdot P_0
\end{equation}
...
\end{equation}
In dieser angepassten Form beschreibt $\Delta P$ die absolute Wertänderung der Immobilie, basierend auf der relativen Änderung der Energiekosten $\Delta EC_{rel}$. Diese berücksichtigt die Differenz im Energieverbrauch $(E_j - E_{A+})$, die Energiepreisentwicklung $(PE_1 - PE_0)$ sowie die Fläche der Immobilie $A$. $P_0$ stellt den aktuellen Immobilienpreis dar.
