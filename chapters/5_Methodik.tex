...
Abbildung \ref{fig:folowchart} visualisiert diesen Datenaufbereitungsprozess. Der Prozess startet mit dem Einlesen einer CSV-Datei. Diese enthält Immobilien-ID, Geometrie, Überschwemmungsrisiko, Energieklasse und Quadratmeterpreise. Es folgt die Erstellung und Bearbeitung verschiedener Spalten. Mehrere Berechnungsschritte sind involviert. Zwei Entscheidungspunkte betreffen den LTV-Mittelwert und den Darlehensbetrag. Je nach Ergebnis werden unterschiedliche Aktionen ausgeführt. Der Prozess endet mit der Speicherung in einer neuen CSV-Datei. Abschließend wird der endgültige Mittelwert des Darlehensbetrags überprüft. Das Diagramm zeigt einen strukturierten Datenverarbeitungsablauf zur Immobilienbewertung.
\begin{figure}[H]
    \centering
