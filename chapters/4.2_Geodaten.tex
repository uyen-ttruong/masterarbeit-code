...
\begin{table}[htbp]
    ...
    \begin{tabularx}{1.0\textwidth}{>{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X}
        ...
        \midrule
        plz & Postleitzahl, eine numerische Kennung eines geographischen Gebiets \\
        \addlinespace
        einwohner & Die Einwohnerzahl eines bestimmten Gebiets oder Ortes \\
        \addlinespace
        qkm & Die Fläche des Gebiets in Quadratkilometern \\
        \addlinespace
        geometry & Die geometrische Darstellung oder Koordinaten des Gebiets \\
        \addlinespace
