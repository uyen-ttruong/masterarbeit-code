...
df = pd.read_csv('flutbayern.csv', delimiter=';', dtype={'geometry': str}, low_memory=False)
...
try:
    gdf.to_file('flutbayern_shapefile_test.shp')
    print("Conversion completed. Shapefile saved as 'flutbayern_shapefile_test.shp'")
except Exception as e:
